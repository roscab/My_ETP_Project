...
class Candidate(models.Model):
    ...
    STATUS_OPTIONS = [('Pass recruiter interview','Pass recruiter interview'),('Rejected by recruiter','Rejected by recruiter'),('Pass technical interview','Pass technical interview'),('Rejected by technical interviewer','Rejected by technical interviewer'),('Pass BUL interview','Pass BUL interview '),('Rejected by BUL','Rejected by BUL'),('Pass client intreview','Pass client intreview'),('Rejected by client','Rejected by client'),('Rejected pre-offer','Rejected pre-offer'),('Rejected offer','Rejected offer')]
